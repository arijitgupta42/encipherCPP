#ifndef DEVIGNERE_H    // To make sure you don't declare the function more than once by including the header multiple times.
#define DEVIGNERE_H
...
void DeVignere(char file1[20],char file2[20])
{
    ifstream infile;
    ofstream outfile;
